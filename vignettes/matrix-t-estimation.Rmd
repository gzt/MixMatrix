...
example with 75 trials and a maximum number of iterations `max.iter = 10`.
...
```{r dftenexample, echo = FALSE, cache = TRUE}
set.seed(20190621)
df10 <- rep(0,50)
df1050 <-  rep(0,50)
df10100 <-  rep(0,50)
...
for(i in 1:50){
   df10[i] = MLmatrixt(rmatrixt(mean = matrix(0,5,3),df = 10, n = 35, U =diag(5), V =diag(3)), fixed = FALSE, df = 5, max.iter = 10)$nu
   df1050[i] = MLmatrixt(rmatrixt(mean = matrix(0,5,3),df = 10, n = 50, U =diag(5), V =diag(3)), fixed = FALSE, df = 5, max.iter = 10)$nu
   df10100[i] = MLmatrixt(rmatrixt(mean = matrix(0,5,3),df = 10, n = 100, U =diag(5), V =diag(3)), fixed = FALSE, df = 5, max.iter = 10)$nu
}


dfdataframe = data.frame(label = c('10 df'),
                         estdf = c(df10, df1050, df10100),
                         samplesize = factor(rep(c(35,50,100), each = 50)))
library(ggplot2)
library(dplyr)
library(magrittr)
denseplot <- ggplot(data = subset(dfdataframe, estdf < 200),aes(x=estdf, fill=samplesize)) +
...
As expected, increased sample size leads to better results in recovering the parameter.
