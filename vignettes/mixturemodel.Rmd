...
As in the case of mixture modeling in general [@fraley2002model; @viroli2011class; @mclachlan2019finite], 
...
library(MixMatrix)
 ...
 B <- rmatrixt(30,mean=matrix(2,nrow=3,ncol=4), df = 10) # 3x4 matrices with mean 2
